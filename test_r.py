...
os.environ["WANDB_API_KEY"] = 'a56cb8012f75bac7eb4670a5cdaff5aa677f4ce9'
...
if __name__ == '__main__':
    ...
    # test
    attack_name = 'AutoDAN-Turbo'
    dataset_name = 'JailbreakBench'
    in_file = os.path.join(f'./data/JailbreakBench.json')
    out_file = os.path.join(f'./data/{attack_name}_{dataset_name}.json')
    ...
    for i, row in enumerate(data_2):
        ...
        test_request = row['jailbreak prompt']
        ...
        temp = {
            'index': i,
            'weak prompt': test_request,
            'jailbreak prompt': test_jailbreak_prompt
        }
        records.append(temp)
